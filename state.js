...
function getLevelRequirement(type, currentLevel) {
    const baseMap = { dog: 20, elephant: 35, squirrel: 10, chicken: 15, bee: 8, bear: 15 };
...
// non-numeric perks (dog digging, chicken egg-laying, etc.) stay as their own `if (this.level >= X)`
// checks in Pet.update() since they're more than a food/water number.
const FORAGE_TIERS = {
